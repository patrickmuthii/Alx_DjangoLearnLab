...
SECRET_KEY = 'django-insecure-!ffg%buqj8+!5$gk$a+x&0!eb)vd%r7^zzrjqu#s%)0984-q4l'
...
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'muripatrick101@gmail.com'
# EMAIL_HOST_PASSWORD = 'kehe jxfs pasl ptou'
